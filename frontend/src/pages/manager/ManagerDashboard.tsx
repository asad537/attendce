...
export default function ManagerDashboard({ executive = false }: { executive?: boolean }) {
  ...
  return <div className="space-y-5 p-4 sm:p-6">
    ...
    <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 min-[1800px]:grid-cols-4">
    ...
    <section className="grid grid-cols-1 gap-4 min-[1600px]:grid-cols-[0.85fr_1.15fr]">

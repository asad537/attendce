            ...
            {canManageCats && (showAddCat ? (
              <div className="mt-4 space-y-2 border-t border-gray-100 pt-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={handleAddCategory} disabled={!catName.trim()} className="flex-1 bg-[#2bb48c] text-white rounded-lg py-2 text-sm font-semibold hover:bg-[#239976] disabled:opacity-50">Add</button>

...
export default function CalendarPage() {
  ...
  // Category filtering removed from the sidebar — always show every event.
        ...
        <div className="flex-1 min-w-0 bg-white rounded-3xl p-6 shadow-sm border border-gray-100 flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button onClick={() => setShowDetails(value => !value)} className="flex items-center gap-2 px-3 py-1.5 bg-emerald-50 text-emerald-700 rounded-lg text-sm font-semibold ">

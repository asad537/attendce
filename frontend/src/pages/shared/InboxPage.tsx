...
function TypingIndicator() {
  return <span aria-label="Typing" className="absolute bottom-16 left-5 z-10 inline-flex h-8 w-8 items-center justify-center gap-1 rounded-full border-2 border-slate-100 bg-white shadow-sm">

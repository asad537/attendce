        ...
        <div className="fixed inset-0 z-50 flex flex-col bg-gradient-to-b from-[#0c241b] to-[#04120d] text-white">
            ...
            <div className="relative z-10 flex flex-1 flex-col items-center justify-between px-6 py-12">
                <div className="flex flex-col items-center gap-4 pt-8">
                    ...
                    {error && (
                        <p className="max-w-xs rounded-lg bg-[#e94141]/90 px-3 py-2 text-center text-xs">
                            {error}
                        </p>
                    )}
                </div>
                ...
                {status === "incoming" ? (
                    ...
                    <div className="flex items-center gap-5">
                        <button
                            onClick={toggleMute}
                            className={`grid h-14 w-14 place-items-center rounded-full text-xl transition ${muted ? "bg-white text-[#0c241b]" : "bg-white/15 /25"}`}
                        ...
                        {isVideo && (
                            <button
                                onClick={toggleCam}
                                className={`grid h-14 w-14 place-items-center rounded-full transition ${camOff ? "bg-white text-[#0c241b]" : "bg-white/15 /25"}`}
                                title={
                                    camOff
                                        ? "Turn camera on"
                                        : "Turn camera off"

...
export default function SettingsPage() {
  ...
  return <div className="min-h-full bg-[#f7f9f8] p-4 text-[#17251f] sm:p-6 lg:p-8"><div className="max-w-6xl"><header className="mb-6"><h1 className="text-[26px] font-bold tracking-[-.03em]">My Settings</h1></header><ProfileSettingsModal isOpen embedded defaultTab={canEdit ? "dashboard" : "appearance"} dashboardSettings={canEdit ? dashboardSettings : undefined} onClose={() => undefined} /></div></div>;
}

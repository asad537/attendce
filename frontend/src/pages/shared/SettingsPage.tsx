...
export default function SettingsPage() {
  ...
  const dashboardSettings = <div className="space-y-5">
    {!canEdit && <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">Only the President and managers can change dashboard settings. You can preview but not save.</div>}
  ...
  return <div className="min-h-full bg-[#f7f9f8] p-4 text-[#17251f] sm:p-6 lg:p-8"><div className="max-w-6xl"><header className="mb-6"><h1 className="text-[26px] font-bold tracking-[-.03em]">My Settings</h1></header><ProfileSettingsModal isOpen embedded defaultTab="dashboard" dashboardSettings={dashboardSettings} onClose={() => undefined} /></div></div>;
}

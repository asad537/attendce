...
export default function CeoAttendance() {
  ...
  // Keep the attendance list current without visually reloading it every two
  // seconds. Focus/reconnect still refresh immediately via useAutoRefresh.
  useAutoRefresh(() => { void load(1, true); }, { intervalMs: 15_000 });

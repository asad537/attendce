...
const statusColor: Record<string, string> = {
  ...
  work_from_home: 'bg-indigo-50 text-indigo-700 ring-indigo-200', weekend: 'bg-gray-50 text-gray-500 ring-gray-200',
};
...
export default function CeoAttendance() {
  ...
  return <div className="space-y-5 p-4 sm:p-6">
    <header className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
      <div><div className="mb-2 inline-flex rounded-lg bg-indigo-50 px-2.5 py-1 text-xs font-semibold text-indigo-600">ATTENDANCE</div><h1 className="text-2xl font-bold tracking-tight text-gray-950">Company Attendance</h1><p className="mt-1 text-sm text-gray-500">Track workforce attendance, working hours and punctuality.</p></div>
    ...
    <section className="grid grid-cols-2 gap-3 lg:grid-cols-4">{[
      ['Total Records', summary.total, 'bg-indigo-50 text-indigo-600', '◎'], ['Present', summary.present, 'bg-emerald-50 text-emerald-600', '✓'],

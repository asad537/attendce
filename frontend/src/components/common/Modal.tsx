      ...
      <div className="flex min-h-full items-center justify-center p-2 sm:p-4">
        ...
        <div className={`relative bg-white rounded-2xl shadow-xl w-full ${sizes[size]} transform transition-all flex flex-col`}>
          ...
          <div className="flex items-center justify-between px-4 py-3 sm:px-6 sm:py-4 border-b border-gray-100">
            ...
            <button onClick={onClose} className="text-gray-400 hover:text-gray-600 p-1.5 rounded-lg transition-colors flex-shrink-0 bg-gray-50 hover:bg-gray-100">
          ...
          {/* Body */}
          <div className="px-4 py-4 sm:px-6 sm:py-5 overflow-y-auto overflow-x-hidden">{children}</div>
        </div>
      </div>
    </div>
  );

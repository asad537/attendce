        ...
        <div className="relative bg-white text-gray-800 rounded-xl shadow-2xl w-full max-w-[1200px] transform transition-all flex flex-col min-h-[85vh] border border-gray-100">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            ...
            <div className="flex items-center gap-2">
              <button className="text-gray-400 hover:text-gray-700 p-1.5 rounded hover:bg-gray-100 transition-colors">
              ...
              <button onClick={onClose} className="text-gray-400 hover:text-gray-800 p-1.5 rounded hover:bg-gray-100 transition-colors ml-2">
